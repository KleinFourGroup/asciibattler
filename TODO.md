...
- [x] **The evaluator exchange rate as a dial** — ✅ 94g-1 (2026-09-06): `rollout.dpTailScale` (`ROLLOUT_KNOBS`, the `rollout` knob group; `DP_TAIL_SCALE` stays the import-time default); the 5-vs-10 read = `output/box-batches/94g-dptail5.queue` (the λ=0 probe did NOT close the ceilings — WORKLOG §94a).
