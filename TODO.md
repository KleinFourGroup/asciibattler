...
- [ ] **Show the pool everywhere** (verdict 7b) — events included; folds into the §94 UI item.
- [ ] **Rename pool health → morale?** (verdict 7c) — a DESIGN naming decision for the user at §94.
