...
describe('harness economy seam (59a)', () => {
  ...
  it('the port seam is LIVE — a buy-nothing stub zeroes purchases the baseline made', () => {
    ...
    // at 56a, 12→2 at 61d, 2→3 at 74i-c) — the walk that provably docks
    // with funds. Same re-pin contract: if an engine round re-deals the
    // streams, re-scan there first and this follows.
