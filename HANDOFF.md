...
- **Tests:** **3131 main (0 skipped) + 582 fuzz:smoke**, green; main re-counted 2026-09-25 (108c, `npm test` before its commit), fuzz:smoke last run at `a9c16ef`. Typecheck clean. The hook takes ~45 s for docs and UI, ~7 min when the smoke runs.
