...
turn:resolved           { turn; winner; pool chips; result; pools }                 # H4b: post-turn outcome cue (gated path only); 91a2: the chips are the APPLIED losses (not a re-derivation of the rule)
