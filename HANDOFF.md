...
- **Tests:** **3126 main (0 skipped) + 582 fuzz:smoke**, green; main re-counted 2026-09-24 (108b, the hook at `509387b`), fuzz:smoke last run at `a9c16ef`. Typecheck clean. The hook takes ~45 s for docs and UI, ~7 min when the smoke runs.
