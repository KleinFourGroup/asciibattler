...
- **NEXT — ROUND 7.5 (The Board), §106: the projection spike, pass two + the spec.** Kicked off 2026-09-22; the cut and its reads are user-signed (ROADMAP §106, WORKLOG §106 Kickoff).
  ...
  - **Open ◐ (`batch`, read at 106e's stop): the two 106d-rider bugs**, fixed 2026-09-23: hills follow the theme (`c348964`) and the empower chips fit the compact card. Read scripts: WORKLOG §"The 106d riders".
  - **(1) 106e, the spec** (`stop`, open ◐): drafted 2026-09-23 as [round-7.5-spec.md](round-7.5-spec.md) — D1–D8 (D3 decided: the marks as signed-distance shapes in the terrain shader; the rest await the user's signature) and §107–§109 entered in ROADMAP unsigned. On signing: §107's kickoff (audit, cut, reads).
