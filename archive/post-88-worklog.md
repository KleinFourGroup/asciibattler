> **🗄️ ARCHIVED 2026-09-08 at the §94i close — THE CASUALTY EXPERIMENT (§89–§94, the encounter feel interstitial), the project's first experimental round: §93 KEEP (user-signed 2026-09-05), the sheet re-anchored + signed at 94h (2026-09-08). The live worklog is [../WORKLOG.md](../WORKLOG.md) (Round 7, Idioms); the plan pair is [post-88-roadmap.md](post-88-roadmap.md) and the spec [encounter-feel-spec.md](encounter-feel-spec.md).**
