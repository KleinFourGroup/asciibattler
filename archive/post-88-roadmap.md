> **🗄️ ARCHIVED 2026-09-08 at the §94i close — the plan of THE CASUALTY EXPERIMENT (§89–§94), every phase closed and user-signed: §89 the data phase · §90 the seam floor · §91 the casualty rule · §92 the rebalance · §93 ⛔ KEEP · §94 the encounter list + the signing. Its worklog is [post-88-worklog.md](post-88-worklog.md), its spec [encounter-feel-spec.md](encounter-feel-spec.md); the live plan is [../ROADMAP.md](../ROADMAP.md) (Round 7, Idioms).**
