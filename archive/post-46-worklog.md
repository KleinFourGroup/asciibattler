...
> **🗄️ ARCHIVED 2026-07-11** at the micro-round kickoff, as a pair with
> [post-46-roadmap.md](post-46-roadmap.md) (+ the spec,
> [cluster-3-spec.md](cluster-3-spec.md)). The live worklog is now the micro
> round's [WORKLOG.md](../WORKLOG.md). *(Original header kept verbatim
