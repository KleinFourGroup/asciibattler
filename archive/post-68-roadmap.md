...
- [x] 72f — the signing session + the round close ✅ CLOSED
      2026-08-04, all items user-signed: the ARBITRATED DEFAULT
      (10 primaries + 5 controls) · wall dose ×1.25 via the
      sector-pool split · seam 15–18 · fire +0.10 · cap-10/Surge-3 ·
      closing cycle 0 FAIL / 3 pre-registered WARNs. BALANCE §72f ×2
      + WORKLOG §72.
