...
- [x] **68h** — the round-close ritual ✅ 2026-07-29 (user-signed,
  straight through): the instrument registry + 53g replay retirement
  (`21592c6`) · the fourth scratchpad sweep (`fef3a47`) · archive
  post-60-* + cursor flip; caps left for the interstitial authoring
  (precedent). Worklog §68h.
