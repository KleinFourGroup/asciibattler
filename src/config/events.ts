...
// 74f's `describeEventCondition` (the requirement phrases) lives in
// src/ui/eventConditionText.ts since 100e — UI copy through `t()`, so this
// config module carries no player-facing prose (the §95 division).
