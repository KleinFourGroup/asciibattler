...
- **NEXT — ROUND 7.5 (The Board), §107: the projection, built — 107a.** The cut is SIGNED (2026-09-24; ROADMAP §107, four steps 107a–d, one `stop` at 107d, the played read; the audit and a D8 deviation the user decided are in WORKLOG §107 Kickoff). The spec: [round-7.5-spec.md](round-7.5-spec.md).
