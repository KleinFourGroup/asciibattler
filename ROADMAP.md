...
- [ ] 51f — the cohesion sweep + exit: full-run native playtest over every Cluster-3 surface (one deliberate Mercury denial-line look), triage fix-vs-TODO, docs + cursor flip — sweep findings #1–2 (the miner tally label, **Run v36→v37** · derived hit/crit on the ability rows) fixed in-phase 2026-07-11 (worklog §51f)
