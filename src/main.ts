...
// §79g — a SELF-HOSTED subset (generated by `npm run gen:font`), replacing
// `@fontsource/jetbrains-mono/latin-400.css`: fontsource publishes no subset
// carrying box-drawing/block-elements, so `╥`/`▄` — every wall, half-cover and
// rubble entity — rendered from an unspecified OS fallback (§79f). See
// src/fonts.css and assets/fonts/jetbrains-mono/README.md.
import './fonts.css';
